      ...
      <button @click="openMenu = !openMenu" :class="openMenu ? 'bg-[#282828]' : 'bg-black'"
        ...
        <div class="flex items-center">
          ...
          <img class="rounded-full" width="27"
            src="https://media.licdn.com/dms/image/C5603AQEKlMfWNOU8dg/profile-displayphoto-shrink_200_200/0/1659547514809?e=1687392000&v=beta&t=QKiqjg8iGZ3SbNZoucjcMbK27kivd8b7cpfUbGGvOLI"
            alt="">
          <div class="text-white text-[14px] ml-1.5 mr-0.5 font-semibold"> Khellum dev</div>
